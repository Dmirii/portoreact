...
export const mainDB = {
    ...
    mySkils:[
        ...
        ['/portoreact/img/p/layout.jpg','Верстка',
        ...
        ['/portoreact/img/p/npm.jpg','Общие задачи',
            ['Gulp','Yarn','npm','PerfectPixel','Webpack',],
            ['dimaaru','Gulp','Yarn','npm','Webpack',],
            ['39','15',],
            '12.04.2020',
        ],
        ['/portoreact/img/p/react.png','Библиотеки JS',
            ['Node.JS','React.JS',],
            ['dimaaru','React','Node'],
            ['3','20',],
            '16.04.2020',
        ],
        ['/portoreact/img/p/bd.jpg','БД',
            ['Mongo DB','Firebase',],
            ['dimaaru','Mongo','Fierbase',],
            ['2','15',],
            '19.04.2020',
        ],
        ['/portoreact/img/p/mern.png','Стеки',
            ['MERN',],
